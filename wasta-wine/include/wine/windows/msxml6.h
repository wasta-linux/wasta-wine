/*** Autogenerated by WIDL 5.20 from include/msxml6.idl - Do not edit ***/
...
IXMLHTTPRequest2 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE Open(
        ...
        const WCHAR *proxy_username,
        const WCHAR *proxy_password) = 0;

    virtual HRESULT STDMETHODCALLTYPE Send(
        ISequentialStream *body,
        ULONGLONG body_size) = 0;
...
/*** IXMLHTTPRequest2 methods ***/
#define IXMLHTTPRequest2_Open(This,method,url,callback,username,password,proxy_username,proxy_password) (This)->lpVtbl->Open(This,method,url,callback,username,password,proxy_username,proxy_password)
#define IXMLHTTPRequest2_Send(This,body,body_size) (This)->lpVtbl->Send(This,body,body_size)
...
#define IXMLHTTPRequest2_GetCookie(This,url,name,dwFlags,cookies_count,cookies) (This)->lpVtbl->GetCookie(This,url,name,dwFlags,cookies_count,cookies)
...
/*** IXMLHTTPRequest2 methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest2_Open(IXMLHTTPRequest2* This,const WCHAR *method,const WCHAR *url,IXMLHTTPRequest2Callback *callback,const WCHAR *username,const WCHAR *password,const WCHAR *proxy_username,const WCHAR *proxy_password) {
    return This->lpVtbl->Open(This,method,url,callback,username,password,proxy_username,proxy_password);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_Send(IXMLHTTPRequest2* This,ISequentialStream *body,ULONGLONG body_size) {
    return This->lpVtbl->Send(This,body,body_size);
}
...
static FORCEINLINE HRESULT IXMLHTTPRequest2_GetCookie(IXMLHTTPRequest2* This,const WCHAR *url,const WCHAR *name,DWORD dwFlags,ULONG *cookies_count,XHR_COOKIE **cookies) {
    return This->lpVtbl->GetCookie(This,url,name,dwFlags,cookies_count,cookies);
}
...
/*** IXMLHTTPRequest2 methods ***/
#define IXMLHTTPRequest3_Open(This,method,url,callback,username,password,proxy_username,proxy_password) (This)->lpVtbl->Open(This,method,url,callback,username,password,proxy_username,proxy_password)
#define IXMLHTTPRequest3_Send(This,body,body_size) (This)->lpVtbl->Send(This,body,body_size)
...
#define IXMLHTTPRequest3_GetCookie(This,url,name,dwFlags,cookies_count,cookies) (This)->lpVtbl->GetCookie(This,url,name,dwFlags,cookies_count,cookies)
#define IXMLHTTPRequest3_GetResponseHeader(This,header,value) (This)->lpVtbl->GetResponseHeader(This,header,value)
/*** IXMLHTTPRequest3 methods ***/
#define IXMLHTTPRequest3_SetClientCertificate(This,hash_size,hash,pin) (This)->lpVtbl->SetClientCertificate(This,hash_size,hash,pin)
#else
/*** IUnknown methods ***/
...
/*** IXMLHTTPRequest2 methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3_Open(IXMLHTTPRequest3* This,const WCHAR *method,const WCHAR *url,IXMLHTTPRequest2Callback *callback,const WCHAR *username,const WCHAR *password,const WCHAR *proxy_username,const WCHAR *proxy_password) {
    return This->lpVtbl->Open(This,method,url,callback,username,password,proxy_username,proxy_password);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_Send(IXMLHTTPRequest3* This,ISequentialStream *body,ULONGLONG body_size) {
    return This->lpVtbl->Send(This,body,body_size);
}
...
static FORCEINLINE HRESULT IXMLHTTPRequest3_GetCookie(IXMLHTTPRequest3* This,const WCHAR *url,const WCHAR *name,DWORD dwFlags,ULONG *cookies_count,XHR_COOKIE **cookies) {
    return This->lpVtbl->GetCookie(This,url,name,dwFlags,cookies_count,cookies);
}
...
/*** IXMLHTTPRequest3 methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3_SetClientCertificate(IXMLHTTPRequest3* This,DWORD hash_size,const BYTE *hash,const WCHAR *pin) {
    return This->lpVtbl->SetClientCertificate(This,hash_size,hash,pin);
}
#endif
#endif
...
/*** IXMLHTTPRequest2Callback methods ***/
#define IXMLHTTPRequest2Callback_OnRedirect(This,request,redirect_url) (This)->lpVtbl->OnRedirect(This,request,redirect_url)
#define IXMLHTTPRequest2Callback_OnHeadersAvailable(This,request,status,status_str) (This)->lpVtbl->OnHeadersAvailable(This,request,status,status_str)
#define IXMLHTTPRequest2Callback_OnDataAvailable(This,request,response) (This)->lpVtbl->OnDataAvailable(This,request,response)
#define IXMLHTTPRequest2Callback_OnResponseReceived(This,request,response) (This)->lpVtbl->OnResponseReceived(This,request,response)
#define IXMLHTTPRequest2Callback_OnError(This,request,error) (This)->lpVtbl->OnError(This,request,error)
#else
/*** IUnknown methods ***/
...
/*** IXMLHTTPRequest2Callback methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnRedirect(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *request,const WCHAR *redirect_url) {
    return This->lpVtbl->OnRedirect(This,request,redirect_url);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnHeadersAvailable(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *request,DWORD status,const WCHAR *status_str) {
    return This->lpVtbl->OnHeadersAvailable(This,request,status,status_str);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnDataAvailable(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *request,ISequentialStream *response) {
    return This->lpVtbl->OnDataAvailable(This,request,response);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnResponseReceived(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *request,ISequentialStream *response) {
    return This->lpVtbl->OnResponseReceived(This,request,response);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnError(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *request,HRESULT error) {
    return This->lpVtbl->OnError(This,request,error);
}
#endif
#endif
...
IXMLHTTPRequest3Callback : public IXMLHTTPRequest2Callback
{
    virtual HRESULT STDMETHODCALLTYPE OnServerCertificateReceived(
        IXMLHTTPRequest3 *request,
        DWORD errors,
        DWORD chain_size,
        const XHR_CERT *chain) = 0;

    virtual HRESULT STDMETHODCALLTYPE OnClientCertificateRequested(
        IXMLHTTPRequest3 *request,
        DWORD issuers_size,
        const WCHAR **issuers) = 0;
...
/*** IXMLHTTPRequest2Callback methods ***/
#define IXMLHTTPRequest3Callback_OnRedirect(This,request,redirect_url) (This)->lpVtbl->OnRedirect(This,request,redirect_url)
#define IXMLHTTPRequest3Callback_OnHeadersAvailable(This,request,status,status_str) (This)->lpVtbl->OnHeadersAvailable(This,request,status,status_str)
#define IXMLHTTPRequest3Callback_OnDataAvailable(This,request,response) (This)->lpVtbl->OnDataAvailable(This,request,response)
#define IXMLHTTPRequest3Callback_OnResponseReceived(This,request,response) (This)->lpVtbl->OnResponseReceived(This,request,response)
#define IXMLHTTPRequest3Callback_OnError(This,request,error) (This)->lpVtbl->OnError(This,request,error)
/*** IXMLHTTPRequest3Callback methods ***/
#define IXMLHTTPRequest3Callback_OnServerCertificateReceived(This,request,errors,chain_size,chain) (This)->lpVtbl->OnServerCertificateReceived(This,request,errors,chain_size,chain)
#define IXMLHTTPRequest3Callback_OnClientCertificateRequested(This,request,issuers_size,issuers) (This)->lpVtbl->OnClientCertificateRequested(This,request,issuers_size,issuers)
#else
/*** IUnknown methods ***/
...
/*** IXMLHTTPRequest2Callback methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnRedirect(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *request,const WCHAR *redirect_url) {
    return This->lpVtbl->OnRedirect(This,request,redirect_url);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnHeadersAvailable(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *request,DWORD status,const WCHAR *status_str) {
    return This->lpVtbl->OnHeadersAvailable(This,request,status,status_str);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnDataAvailable(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *request,ISequentialStream *response) {
    return This->lpVtbl->OnDataAvailable(This,request,response);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnResponseReceived(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *request,ISequentialStream *response) {
    return This->lpVtbl->OnResponseReceived(This,request,response);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnError(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *request,HRESULT error) {
    return This->lpVtbl->OnError(This,request,error);
}
/*** IXMLHTTPRequest3Callback methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnServerCertificateReceived(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest3 *request,DWORD errors,DWORD chain_size,const XHR_CERT *chain) {
    return This->lpVtbl->OnServerCertificateReceived(This,request,errors,chain_size,chain);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnClientCertificateRequested(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest3 *request,DWORD issuers_size,const WCHAR **issuers) {
    return This->lpVtbl->OnClientCertificateRequested(This,request,issuers_size,issuers);
}
#endif
#endif
