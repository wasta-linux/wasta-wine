/*** Autogenerated by WIDL 4.18 from sapi.idl - Do not edit ***/
...
static FORCEINLINE HRESULT ISpVoice_Skip(ISpVoice* This,WCHAR *type,LONG items,ULONG *skipped) {
...
#define ISpeechRecoGrammar_CmdLoadFromResource(This,mod,name,yype,language,option) (This)->lpVtbl->CmdLoadFromResource(This,mod,name,yype,language,option)
...
static FORCEINLINE HRESULT ISpeechRecoGrammar_CmdLoadFromResource(ISpeechRecoGrammar* This,LONG mod,VARIANT name,VARIANT yype,SpeechLanguageId language,SpeechLoadOption option) {
    return This->lpVtbl->CmdLoadFromResource(This,mod,name,yype,language,option);
}
...
ISpeechRecognizer : public IDispatch
{
    ...
    virtual HRESULT STDMETHODCALLTYPE get_Status(
        ISpeechRecognizerStatus **satus) = 0;
...
#define ISpeechRecognizer_get_Status(This,satus) (This)->lpVtbl->get_Status(This,satus)
...
static FORCEINLINE HRESULT ISpeechRecognizer_get_Status(ISpeechRecognizer* This,ISpeechRecognizerStatus **satus) {
    return This->lpVtbl->get_Status(This,satus);
}
