/*** Autogenerated by WIDL 5.20 from include/windows.system.idl - Do not edit ***/
...
__CRT_UUID_DECL(ABI::Windows::System::IUserChangedEventArgs, 0x086459dc, 0x18c6, 0x48db, 0xbc,0x99, 0x72,0x4f,0xb9,0x20,0x3c,0xcc)
#endif
#else
...
#endif
#ifdef WIDL_USING_WINDOWS_SYSTEM_IUSERCHANGEDEVENTARGS
...
#endif /* WIDL_USING__WINDOWS_SYSTEM_IUSERCHANGEDEVENTARGS */
#endif
...
static const DECLSPEC_SELECTANY WCHAR RuntimeClass_Windows_System_User[] = {'W','i','n','d','o','w','s','.','S','y','s','t','e','m','.','U','s','e','r',0};
...
static const DECLSPEC_SELECTANY WCHAR RuntimeClass_Windows_System_UserChangedEventArgs[] = {'W','i','n','d','o','w','s','.','S','y','s','t','e','m','.','U','s','e','r','C','h','a','n','g','e','d','E','v','e','n','t','A','r','g','s',0};
